#!/usr/bin/env python3
"""Issue #75 Phase C target-blind M3 candidate-null smoke."""
...
import phase75c_score as score  # noqa: E402
...
def main(argv: Sequence[str]) -> int:
    ...
    authority, cases, c0_sha = score.load_c0()
    candidate, X, audit = score.build_exact_case(src, rep, authority, cases, c0_sha)
    ...
    result = {
        "schema": "issue75-phaseC-m3-candidate-null-smoke-v1",
        "status": "M3_CANDIDATE_OWNED_NULL_EXECUTION_VERIFIED_TARGET_BLIND",
